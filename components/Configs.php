 ...
 *
 * ```
 * Yii::$container->set('vthang87\authmanager\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'admin_menu',
 * ]);
 * ```
...
{
    const CACHE_TAG = 'vthang87.admin';
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'vthang87.admin.configs', []);
